...
import { createUser, getUserInfo, updateUser, createUserPost } from "../controllers/userController.js";
...
router.post("/v1/user", createUser, checkDBConnection, createUserPost);
